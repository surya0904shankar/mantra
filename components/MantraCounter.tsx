    ...
    <div className="flex flex-col items-center justify-center h-full max-w-md mx-auto w-full py-6 animate-in zoom-in-95 duration-500">
      ...
      <div className="w-full space-y-4 px-4">
        ...
        <button
          ...
          className="w-full bg-stone-900 dark:bg-stone-100 hover:bg-stone-800 dark:hover:bg-stone-200 active:bg-black text-white dark:text-stone-900 rounded-2xl py-5 text-xl font-medium shadow-xl shadow-stone-200 dark:shadow-stone-900/20 transition-all flex items-center justify-center gap-2 disabled:opacity-50 font-serif"
        >
          <Plus size={24} />
          Chant
        </button>
        ...
        <div className="flex gap-3">
           ...
           {!isManualMode ? (
             <button 
                ...
                disabled={isCommitting}
                className="flex-1 bg-white dark:bg-stone-800 border border-stone-200 dark:border-stone-700 hover:bg-stone-50 dark:hover:bg-stone-700 text-stone-600 dark:text-stone-300 py-3 rounded-xl font-medium transition-colors flex items-center justify-center gap-2 font-serif"
             >
